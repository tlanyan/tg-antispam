...
var Translations = map[string]Translation{
	LangSimplifiedChinese: {
		...
		"settings_cmd_premium":         "/toggle_premium - 切换默认封禁Premium用户",
		"settings_cmd_cas":             "/toggle_cas - 切换默认启用CAS验证",
		"settings_cmd_notifications":   "/toggle_notifications - 切换通知管理员",
		"settings_cmd_language":        "/language - 设置机器人语言",
		"settings_cmd_random_username": "/toggle_random_username - 切换默认封禁随机用户名用户",
		"settings_cmd_emoji_name":      "/toggle_emoji_name - 切换默认封禁名字包含表情符号用户",
		"settings_cmd_bio_link":        "/toggle_bio_link - 切换默认封禁个人简介包含可疑链接用户",

		"enabled":  "✅ 启用",
		"disabled": "❌ 禁用",

		"setting_premium":         "封禁Premium用户",
		"setting_cas":             "启用CAS验证",
		"setting_random_username": "封禁随机用户名用户",
		"setting_emoji_name":      "封禁姓名表情符号用户",
		"setting_bio_link":        "封禁个人简介可疑链接用户",
		"setting_notifications":   "通知管理员",
		"setting_language":        "语言",
	...
	LangTraditionalChinese: {
		...
		"help_cmd_toggle_emoji_name":      "/toggle_emoji_name - 切換是否默認禁止名字包含表情符號用户",
		"help_cmd_toggle_bio_link":        "/toggle_bio_link - 切換是否默認禁止個人簡介包含可疑連結用户",
		"help_cmd_toggle_notifications":   "/toggle_notifications - 切換是否通知管理員",
		...
		"settings_cmd_random_username": "/toggle_random_username - 切換隨機用戶名封禁",
		"settings_cmd_emoji_name":      "/toggle_emoji_name - 切換姓名表情符號封禁",
		"settings_cmd_bio_link":        "/toggle_bio_link - 切換個人簡介可疑連結封禁",
