...
var Translations = map[string]Translation{
	LangSimplifiedChinese: {
		...
		"self_unban_success_notification": "✅ <b>用户自助解封成功</b> [%s]\n\n用户 %s 已通过验证成功解除限制。",
	...
	LangTraditionalChinese: {
		...
		"self_unban_success_notification": "✅ <b>用戶自助解封成功</b> [%s]\n\n用戶 %s 已通過驗證成功解除限制。",
	...
	LangEnglish: {
		...
		"self_unban_success_notification": "✅ <b>Self-unban Successful</b> [%s]\n\nUser %s has successfully unrestricted themselves through verification.",
